                    ...
                    <div id = "divStoreDetails" class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                @if( $SOHeader[0]->STATUS != "RECEIVED" ||  $SOHeader[0]->STATUS  != "INCOMPLETE")
                                ...
                                @endif
                                @if( $SOHeader[0]->STATUS == "RECEIVED" || $SOHeader[0]->STATUS == "INCOMPLETE"  || $SOHeader[0]->STATUS == "PENDING")
                                ...
                                <form action="/store-details" method = "POST" class="form">
                                   ...
                                   @else
                                   <button type="submit" class="btn btn-rounded btn-info mb-3" disabled >Submit</button>
                                    @endif
                                </form>
                            </div>
                        </div>
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="/update-details" method = "POST" class="form">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-8"> 
                                                                    <select class="js-example-basic-singleE form-control input-rounded responsive"  id="product-selectE" >
                                                                        <option value="">Select Item</option>
                                                                        @forelse ($productList as $productLists)
                                                                        <option value="{{ $productLists->ID }}">{{ $productLists->InventoryName }} - {{ $productLists->InventoryID }}</option>
                                                                        @empty
                                ...
                                <!-- <table id="dataTable_SOdetails" class="table table-striped table-bordered table-hover"> -->
                                        ...
                                        <tbody>
                                                ...
                                                <td>  
                                                    ...
                                                    <button type="button" class="btn btn-rounded btn-info mb-3" id="btn-delSODetails" data-id="{{ $detail->TransactionID }}" data-id2="{{ $detail->InventoryName }}" title ="Delete"><i class="fa fa-ban" ></i></button>
                                                    @else
                                                    <button type="button" class="btn btn-rounded btn-info mb-3 ediHeaderD-btn" id="btn-editSODetailsModal" data-id="{{ $detail->TransactionID }}" data-id2="{{ $detail->InventoryName }}" data-id3="{{ $detail->ItemCode }}" data-id4="{{ $detail->UOM_Desc }}" data-id5="{{ $detail->PO_QTY}}" data-toggle="modal" data-target="#editSODModal" title="Edit Details" disabled><i class="fa fa-edit"></i></button>
                                                    <button type="button" class="btn btn-rounded btn-info mb-3" id="btn-delSODetails" data-id="{{ $detail->TransactionID }}" data-id2="{{ $detail->InventoryName }}" title ="Delete" disabled><i class="fa fa-ban"></i> </i></button>
                                                    @endif
