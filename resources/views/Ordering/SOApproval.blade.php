                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <div class="breadcrumbs-area clearfix">
                                <h4 class="page-title pull-left">SO {{$DataType}}</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="data-tables">
                                    <table id="soApp_dTable" class="table table-striped table-bordered table-hover">
										@csrf	
                                        ...
                                        <tbody>
                                                ...
                                                <td>{{ $detail->STATUS }}</td>
                                                <td>
                                                    <a href="/createSOApp-list/{{ $detail->SONumber }}/" class="btn btn-rounded btn-info mb-3" ><i class="fa fa-folder-open"></i></a>
                                                    {{-- <button type="button" class="btn btn-rounded btn-info mb-3 loadSO-btn" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="fa fa-plus"> Add Header & Upload</i></button> --}}
                                                </td>
                                                </tr>
                                                @empty
                                                <tr>
