                                                    ...
                                                    <div class="modal-body">
                                                        <form action="/update-details" method = "POST" class="form">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-8"> 
                                                                    <select class="js-example-basic-singleE form-control input-rounded responsive"  id="product-selectE" style="width: 500px;">
                                                                        <option value="">Select Item</option>
                                                                        @forelse ($productList as $productLists)
                                                                        <option value="{{ $productLists->ID }}">{{ $productLists->InventoryName }} - {{ $productLists->InventoryID }}</option>
                                                                        @empty
                                ...
                                <!-- <table id="dataTable_SOdetails" class="table table-striped table-bordered table-hover"> -->
                                        ...
                                        <tbody>
                                                ...
                                                <td>  
                                                    ...
                                                    <button type="button" class="btn btn-rounded btn-info mb-3" id="btn-delSODetails" data-id="{{ $detail->TransactionID }}" data-id2="{{ $detail->InventoryName }}" data-id3 ="{{ $SOHeader[0]->SONumber }}" title ="Delete" disabled><i class="fa fa-ban"></i> </i></button>
                                                    @endif
