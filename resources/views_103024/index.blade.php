        ...
        <div class="sidebar-menu">
            ...
            <div class="main-menu">
                <div class="menu-inner">
				    ...
				    <li><a href="/vendor">Vendor Lists</a></li>
...
let table = new DataTable('#vendor_dTable', 
    {
    columns: [
        { mDataProp: 'id' },
        { mDataProp: 'Supplier Code' },
        { mDataProp: 'Name' },
        { mDataProp: 'Remarks' },
        { mDataProp: 'Status' },
        { mDataProp: 'POC' },
        { mDataProp: 'ContactInformation' },        
        { mDataProp: null, render: function(data, type, row) {
            return '<button type="button" class="btn btn-rounded btn-info mb-3 edit-buttonV" data-toggle="modal" data-target="#EditModal" data-id="' + row.id + '" data-id2="' + row.SuppCode + '" data-id3="' + row.Name + '" data-id4="' + row.Remarks + '" data-id5="' + row.Status + '" data-id6="' + row.POC + '" data-id7="' + row.ConctactInformation + '"><i class="fa fa-edit"></i></button>';
        } }
    ],columnDefs: [ { "defaultContent": "-", "targets": "_all" } ]
});
...
<script>
    $(document).ready(function() {
        $('.edit-buttonV').click(function() {
            var rowId = $(this).data('id');
                var rowSupplier = $(this).data('id2');
                var rowValue = $(this).data('id3');
                var rowSettingName = $(this).data('id4');
                var rowDescription = $(this).data('id5');
                $('#editItemIdE').val(rowId);
                $('#SupplierCode').val(rowSupplier);
                $('#ValueE').val(rowValue);
                $('#SettingNameE').val(rowSettingName);
                $('#DescriptionE').val(rowDescription);
            });
